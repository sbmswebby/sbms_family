...
import { 
  Search, Filter, RotateCcw, XCircle, 
  ArrowUpAz, ArrowDownAz, Calendar, Activity as ActivityIcon,
...
export default function ActivityFilterBar({
    ...
    const timer = setTimeout(() => {
      ...
      filtered.sort((a, b) => {
        ...
        if (sortField === "registrations") {
          const regA = activityStats[a.id]?.totalRegistrations || 0;
          const regB = activityStats[b.id]?.totalRegistrations || 0;
  ...
  }, [searchQuery, statusFilter, typeFilter, dateRange, sortField, sortOrder, activities]);
      ...
      <div className="flex flex-col md:flex-row gap-3">
        <div className="relative flex-1">
          ...
          <input
            ...
            className="w-full bg-gray-900 border border-gray-800 rounded-xl py-3 pl-10 pr-4 text-sm text-white focus:ring-2 focus:ring-blue-600 outline-none"
          />
        </div>
        ...
        <div className="flex gap-2">
          ...
          <div className="flex bg-gray-900 border border-gray-800 rounded-xl overflow-hidden">
            <select
              ...
              className="bg-transparent pl-3 pr-2 py-2 text-sm text-gray-300 outline-none cursor-pointer"
            >
      ...
      {showFilters && (
        <div className="p-6 bg-gray-900 border border-gray-800 rounded-2xl animate-in fade-in slide-in-from-top-2">
          <div className="flex justify-between items-center mb-6">
            <h3 className="text-xs font-bold uppercase tracking-widest text-gray-500">Advanced Filters</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="space-y-2">
              <label className="text-[10px] uppercase font-bold text-gray-500 ml-1">Current Status</label>
              <select
                value={statusFilter}
            ...
            {/* Type Select */}
            <div className="space-y-2">
              <label className="text-[10px] uppercase font-bold text-gray-500 ml-1">Activity Structure</label>
            ...
            <div className="space-y-2">
              ...
              <div className="flex gap-2">
                <input
                  ...
                  className="w-1/2 bg-gray-800 border border-gray-700 rounded-xl p-2 text-xs text-white outline-none"
                />
                <input
                  type="date"
                  value={dateRange.end}
